...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => __WEBPACK_DEFAULT_EXPORT__\n/* harmony export */ });\n/* harmony import */ var _keys__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./keys */ \"./javascript/key_maps/keys.js\");\n // import audioFile from '../../songs/buttercup.mp3'\n\nvar PATH = document.URL.substr(0, document.URL.lastIndexOf('/'));\n\nfunction easy() {\n  var audioTrack = new Audio(\"\".concat(PATH, \"/songs/buttercup.mp3\")); // Grab the keymap letter you want to insert a letter into.\n  // push it in\n  // new KeyX(imageType, position in line);\n\n  var keyMap = {\n    a: [],\n    s: [],\n    d: [],\n    f: [],\n    j: [],\n    k: [],\n    l: [],\n    colon: [],\n    space: []\n  }; // keyMap[\"a\"].push(new KeyA());\n  // keyMap[\"s\"].push(new KeyS());\n  // keyMap[\"l\"].push(new KeyL());\n  // keyMap[\"colon\"].push(new KeyColon());\n\n  keyMap[\"d\"].push(new _keys__WEBPACK_IMPORTED_MODULE_0__.KeyD(1, 1.0));\n  keyMap[\"a\"].push(new _keys__WEBPACK_IMPORTED_MODULE_0__.KeyA(2, 4.5));\n  keyMap[\"s\"].push(new _keys__WEBPACK_IMPORTED_MODULE_0__.KeyS(2, 4.5));\n  keyMap[\"d\"].push(new _keys__WEBPACK_IMPORTED_MODULE_0__.KeyD(1, 5.8));\n  keyMap[\"a\"].push(new _keys__WEBPACK_IMPORTED_MODULE_0__.KeyA(2, 6.8));\n  keyMap[\"s\"].push(new _keys__WEBPACK_IMPORTED_MODULE_0__.KeyS(2, 6.8));\n  keyMap[\"d\"].push(new _keys__WEBPACK_IMPORTED_MODULE_0__.KeyD(1, 7.2));\n  keyMap[\"d\"].push(new _keys__WEBPACK_IMPORTED_MODULE_0__.KeyD(1, 8));\n  keyMap[\"a\"].push(new _keys__WEBPACK_IMPORTED_MODULE_0__.KeyA(2, 9.2));\n  keyMap[\"f\"].push(new _keys__WEBPACK_IMPORTED_MODULE_0__.KeyF(2, 9.2));\n  keyMap[\"s\"].push(new _keys__WEBPACK_IMPORTED_MODULE_0__.KeyS(2, 10.5));\n  keyMap[\"f\"].push(new _keys__WEBPACK_IMPORTED_MODULE_0__.KeyF(2, 10.5));\n  keyMap[\"d\"].push(new _keys__WEBPACK_IMPORTED_MODULE_0__.KeyD(2, 11.5));\n  keyMap[\"a\"].push(new _keys__WEBPACK_IMPORTED_MODULE_0__.KeyA(2, 11.5));\n  keyMap[\"a\"].push(new _keys__WEBPACK_IMPORTED_MODULE_0__.KeyA(2, 12.5));\n  keyMap[\"s\"].push(new _keys__WEBPACK_IMPORTED_MODULE_0__.KeyS(2, 12.5));\n  keyMap[\"d\"].push(new _keys__WEBPACK_IMPORTED_MODULE_0__.KeyD(2, 13));\n  keyMap[\"f\"].push(new _keys__WEBPACK_IMPORTED_MODULE_0__.KeyF(2, 13));\n  keyMap[\"d\"].push(new _keys__WEBPACK_IMPORTED_MODULE_0__.KeyD(1, 13.5));\n  keyMap[\"f\"].push(new _keys__WEBPACK_IMPORTED_MODULE_0__.KeyF(1, 14));\n  keyMap[\"a\"].push(new _keys__WEBPACK_IMPORTED_MODULE_0__.KeyA(1, 14.5));\n  keyMap[\"s\"].push(new _keys__WEBPACK_IMPORTED_MODULE_0__.KeyS(1, 15.2));\n  keyMap[\"a\"].push(new _keys__WEBPACK_IMPORTED_MODULE_0__.KeyA(1, 16));\n  keyMap[\"s\"].push(new _keys__WEBPACK_IMPORTED_MODULE_0__.KeyS(1, 17));\n  keyMap[\"d\"].push(new _keys__WEBPACK_IMPORTED_MODULE_0__.KeyD(1, 17.5));\n  keyMap[\"f\"].push(new _keys__WEBPACK_IMPORTED_MODULE_0__.KeyF(1, 18.2));\n  keyMap[\"d\"].push(new _keys__WEBPACK_IMPORTED_MODULE_0__.KeyD(1, 19));\n  keyMap[\"f\"].push(new _keys__WEBPACK_IMPORTED_MODULE_0__.KeyF(1, 20));\n  keyMap[\"a\"].push(new _keys__WEBPACK_IMPORTED_MODULE_0__.KeyA(2, 21));\n  keyMap[\"s\"].push(new _keys__WEBPACK_IMPORTED_MODULE_0__.KeyS(2, 21));\n  keyMap[\"d\"].push(new _keys__WEBPACK_IMPORTED_MODULE_0__.KeyD(1, 22.5));\n  keyMap[\"f\"].push(new _keys__WEBPACK_IMPORTED_MODULE_0__.KeyF(1, 23.5)); // Beat drop\n\n  keyMap[\"a\"].push(new _keys__WEBPACK_IMPORTED_MODULE_0__.KeyA(1, 24));\n  keyMap[\"s\"].push(new _keys__WEBPACK_IMPORTED_MODULE_0__.KeyS(1, 24.5));\n  keyMap[\"d\"].push(new _keys__WEBPACK_IMPORTED_MODULE_0__.KeyD(1, 25));\n  keyMap[\"f\"].push(new _keys__WEBPACK_IMPORTED_MODULE_0__.KeyF(1, 25.5));\n  keyMap[\"a\"].push(new _keys__WEBPACK_IMPORTED_MODULE_0__.KeyA(1, 26));\n  keyMap[\"s\"].push(new _keys__WEBPACK_IMPORTED_MODULE_0__.KeyS(1, 26.5));\n  keyMap[\"d\"].push(new _keys__WEBPACK_IMPORTED_MODULE_0__.KeyD(1, 27));\n  keyMap[\"f\"].push(new _keys__WEBPACK_IMPORTED_MODULE_0__.KeyF(1, 27.5));\n  keyMap[\"a\"].push(new _keys__WEBPACK_IMPORTED_MODULE_0__.KeyA(2, 28));\n  keyMap[\"s\"].push(new _keys__WEBPACK_IMPORTED_MODULE_0__.KeyS(2, 28));\n  return [keyMap, audioTrack];\n}\n\n/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (easy);\n\n//# sourceURL=webpack://keyrevolution/./javascript/key_maps/easy.js?");
