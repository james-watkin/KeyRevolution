...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => __WEBPACK_DEFAULT_EXPORT__\n/* harmony export */ });\n/* harmony import */ var _keys__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./keys */ \"./javascript/key_maps/keys.js\");\n\nvar PATH = document.URL.substr(0, document.URL.lastIndexOf('/'));\n\nfunction hard() {\n  var audioTrack = new Audio(\"\".concat(PATH, \"/songs/buttercup.mp3\")); // Grab the keymap letter you want to insert a letter into.\n  // push it in\n  // new KeyX(imageType, position in line);\n\n  var keyMap = {\n    a: [],\n    s: [],\n    d: [],\n    f: [],\n    j: [],\n    k: [],\n    l: [],\n    colon: [],\n    space: []\n  };\n  var a = [35, 319, 406, 681, 802, 919, 1160, 1220, 1266, 1313, 1581, 1821, 2418, 2539, 2598, 2839, 2958, 3015, 3226, 3288, 3679, 3722, 4036, 4144, 4398, 4472, 4506];\n  var d = [138, 200, 469, 618, 742, 861, 1009, 1056, 1103, 1369, 1462, 1520, 1640, 1699, 1760, 1854, 2002, 2182, 2238, 2270, 2675, 2777, 2823, 2899, 3046, 3109, 3167, 3346, 3408, 3468, 3559, 3597, 3860, 4007, 4203, 4280, 4336, 4543];\n  var f = [170, 500, 682, 802, 1023, 1071, 1400, 1462, 1700, 1943, 2121, 2210, 2253, 2299, 2703, 2792, 3080, 3139, 3376, 3499, 3707, 3753, 3950, 4233, 4281, 4558, 4624];\n  var s = [76, 261, 378, 438, 529, 617, 743, 861, 980, 1131, 1207, 1249, 1298, 1519, 1581, 1640, 1789, 1882, 2060, 2359, 2476, 2569, 2659, 2766, 2808, 2869, 2925, 2987, 3199, 3258, 3317, 3437, 3527, 3582, 3629, 3802, 3916, 3977, 4085, 4203, 4367, 4399, 4444, 4506, 4592, 4691];\n  a.forEach(function (posY) {\n    var key = new _keys__WEBPACK_IMPORTED_MODULE_0__.KeyA(1, (posY - 470) * -1);\n    keyMap[\"a\"].push(key);\n  });\n  s.forEach(function (posY) {\n    var key = new _keys__WEBPACK_IMPORTED_MODULE_0__.KeyS(1, (posY - 470) * -1);\n    keyMap[\"s\"].push(key);\n  });\n  d.forEach(function (posY) {\n    var key = new _keys__WEBPACK_IMPORTED_MODULE_0__.KeyD(1, (posY - 470) * -1);\n    keyMap[\"d\"].push(key);\n  });\n  f.forEach(function (posY) {\n    var key = new _keys__WEBPACK_IMPORTED_MODULE_0__.KeyF(1, (posY - 470) * -1);\n    keyMap[\"f\"].push(key);\n  });\n  return [keyMap, audioTrack];\n}\n\n/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (hard);\n\n//# sourceURL=webpack://keyrevolution/./javascript/key_maps/hard.js?");
...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => __WEBPACK_DEFAULT_EXPORT__\n/* harmony export */ });\n/* harmony import */ var _keys__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./keys */ \"./javascript/key_maps/keys.js\");\n\nvar PATH = document.URL.substr(0, document.URL.lastIndexOf('/'));\n\nfunction medium() {\n  var audioTrack = new Audio(\"\".concat(PATH, \"/songs/buttercup.mp3\"));\n  var keyMap = {\n    a: [],\n    s: [],\n    d: [],\n    f: [],\n    j: [],\n    k: [],\n    l: [],\n    colon: [],\n    space: []\n  };\n  var a = [199, 503, 632, 986, 1284, 1374, 1884, 2007, 2183, 2486, 2665, 2784, 3146, 3264, 3564, 3684, 3920, 4220, 4462, 4645];\n  var d = [320, 440, 813, 864, 1165, 1407, 1586, 1705, 1764, 1947, 2065, 2272, 2425, 2604, 2902, 3085, 3204, 3325, 3504, 3744, 3982, 4164, 4402];\n  var f = [377, 532, 811, 1044, 1225, 1467, 1645, 1736, 1947, 2126, 2303, 2363, 2719, 2964, 3204, 3384, 3804, 4042, 4282, 4582];\n  var s = [267, 409, 631, 922, 1106, 1346, 1526, 1855, 2007, 2065, 2243, 2362, 2544, 2844, 3024, 3146, 3265, 3443, 3625, 3684, 3744, 3862, 3981, 4102, 4343, 4518, 4646];\n  a.forEach(function (posY) {\n    var key = new _keys__WEBPACK_IMPORTED_MODULE_0__.KeyA(1, (posY - 470) * -1);\n    keyMap[\"a\"].push(key);\n  });\n  s.forEach(function (posY) {\n    var key = new _keys__WEBPACK_IMPORTED_MODULE_0__.KeyS(1, (posY - 470) * -1);\n    keyMap[\"s\"].push(key);\n  });\n  d.forEach(function (posY) {\n    var key = new _keys__WEBPACK_IMPORTED_MODULE_0__.KeyD(1, (posY - 470) * -1);\n    keyMap[\"d\"].push(key);\n  });\n  f.forEach(function (posY) {\n    var key = new _keys__WEBPACK_IMPORTED_MODULE_0__.KeyF(1, (posY - 470) * -1);\n    keyMap[\"f\"].push(key);\n  });\n  return [keyMap, audioTrack];\n}\n\n/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (medium);\n\n//# sourceURL=webpack://keyrevolution/./javascript/key_maps/medium.js?");
